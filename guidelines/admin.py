...
class GuidelineAdmin(admin.ModelAdmin):
    ...
    list_filter = ('guideline_type', 'authority', 'society', 'category', 'is_published', 'published_at')
    ...
    fieldsets = (
        (None, {'fields': ('title', 'guideline_type', 'society', 'authority', 'category', 'category_name_override')}),
...
@admin.register(ConferenceSociety)
class ConferenceSocietyAdmin(admin.ModelAdmin):
